 ...
 */
function login() {
    return location.href = "http://localhost:9094/page/login";
}
function regist() {
    return location.href = "http://localhost:9094/page/register";
}
...
function search(a) {
    var b = "http://localhost:9092/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
